...
import { getRecap, deleteRecap } from "@/lib/api";
import { toast } from "sonner";
import { ArrowLeft, BookMarked, BookOpen, Sparkles, Compass, FileText, Trash2, AlertTriangle } from "lucide-react";
...
export default function Recap() {
  ...
  useEffect(() => {
    if (recap) return;
    (async () => {
      try { setRecap(await getRecap(id)); } finally { setLoading(false); }
    })();
  }, [id, recap]);
  ...
  return (
    <div className="max-w-5xl" data-testid="recap-page">
      ...
      <div className="bg-[#1D2D50] text-white rounded-xl p-7 md:p-10 mb-8" data-testid="unified-summary">
        <div className="text-xs uppercase tracking-[0.2em] text-[#E5A93C] flex items-center gap-2 mb-3">

...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F0] dark:bg-[#12131A] selection:bg-[#E5A93C] selection:text-[#1A1B26] overflow-x-hidden font-body relative transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col text-left">
              <span className="font-heading text-xl font-bold tracking-tighter text-[#1D2D50] dark:text-white">EduScanner <span className="text-[#B83A4B]">AI</span></span>
          ...
          <div className="flex items-center gap-6">
            <Link to="/login" className="text-[10px] font-black uppercase tracking-[0.2em] text-[#1D2D50] dark:text-white/90 hover:text-[#B83A4B] dark:hover:text-[#E5A93C] transition-colors hidden sm:block">
              Akses Portal
            </Link>
            <Button
      ...
      <section className="relative pt-44 pb-32 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 fade-up relative z-10">
            ...
            <h1 className="font-heading text-5xl md:text-7xl xl:text-8xl text-[#1D2D50] dark:text-white tracking-tighter leading-[0.95] mb-8">
              Riset Akademik, <br />
              <span className="italic text-[#E5A93C] italic-scholarly">Eksklusif.</span>
            </h1>
            
            <p className="text-[#1D2D50] dark:text-white/70 text-lg md:text-xl leading-relaxed max-w-xl font-bold mb-12">
      ...
      <section className="py-20 border-y border-[#1D2D50]/10 dark:border-white/10 bg-[#1D2D50]/5 dark:bg-white/5 backdrop-blur-sm transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center">
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[#1D2D50]/40 dark:text-white/40 mb-12">Kredibilitas Global Melalui Kolaborasi</span>
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 grayscale hover:grayscale-0 transition-all duration-1000 text-[#1D2D50] dark:text-white/50">
              {["UNIVERSITY", "RESEARCH", "SCHOLAR", "INSTITUTE", "ACADEMY"].map((name) => (
                <span key={name} className="text-2xl md:text-3xl font-heading font-black tracking-tighter cursor-default opacity-80 hover:opacity-100">{name}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      <section id="fitur" className="py-32 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-24 max-w-2xl mx-auto fade-up">
          ...
          <h2 className="font-heading text-4xl md:text-6xl text-[#1D2D50] dark:text-white tracking-tighter leading-none mb-6 italic italic-scholarly text-glow-gold">Inovasi <span className="not-italic font-black">Cerdas.</span></h2>
          <p className="text-[#1D2D50] dark:text-white/70 text-base font-bold leading-relaxed">
      ...
      <section id="harga" className="py-32 bg-[#1D2D50] dark:bg-[#0D1527] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          <div className="mb-24">
            ...
            <h2 className="font-heading text-4xl md:text-7xl text-white tracking-tighter italic italic-scholarly leading-none mb-6">Investasi <span className="not-italic font-black text-[#E5A93C]">Akademik.</span></h2>
          </div>
      ...
      {/* Final CTA - Adaptive */}
      <section className="py-32 px-6 lg:px-12 max-w-5xl mx-auto text-center relative transition-colors duration-500">
      ...
      <footer className="py-24 bg-white dark:bg-[#12131A] border-t-4 border-[#E5A93C]/20 relative overflow-hidden transition-colors duration-500">
    ...
    <div className={`relative p-12 rounded-[3.5rem] transition-all duration-1000 hover:scale-[1.03] flex flex-col overflow-hidden ${premium ? 'bg-[#1D2D50] dark:bg-[#121E36] text-white shadow-[0_50px_100px_-20px_rgba(29,45,80,0.4)] scale-105 border-4 border-[#E5A93C] z-10' : 'bg-white dark:bg-white/5 text-[#1D2D50] dark:text-white border-2 border-[#1D2D50]/10 dark:border-white/10 shadow-xl'}`}>
      ...
      <div className="mb-12 text-left">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-6xl font-heading font-black tracking-tighter italic italic-scholarly">{price}</span>
